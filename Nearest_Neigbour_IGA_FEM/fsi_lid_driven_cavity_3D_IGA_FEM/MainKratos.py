...
class CustomCoSimulationAnalysis(CoSimulationAnalysis):
    ...
    def OutputSolutionStep(self):
        ...
        if not hasattr(self, "tracking_conditions_initialized"):
            ...
            self.point_A = (0.502, 0.502)  # Replace with your target coordinates
        ...
        for i, node in enumerate(condition.GetNodes()):
            solution_A += node.GetSolutionStepValue(KratosMultiphysics.DISPLACEMENT_Z) * N[0, i]
    ...
    def Finalize(self):
        ...
        # Plot
        plt.figure()
        plt.plot(self.time_history, self.disp_x_history_A, label=r"$u_z$ at Point A")
